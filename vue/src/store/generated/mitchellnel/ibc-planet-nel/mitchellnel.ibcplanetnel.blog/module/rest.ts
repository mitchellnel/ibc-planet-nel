...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/post
   */
  queryPostAll = (
    query?: {
    ...
    this.request<BlogQueryAllPostResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/post/{id}
   */
  queryPost = (id: string, params: RequestParams = {}) =>
    this.request<BlogQueryGetPostResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/post/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/sent_post
   */
  querySentPostAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<BlogQueryAllSentPostResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/sent_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/sent_post/{id}
   */
  querySentPost = (id: string, params: RequestParams = {}) =>
    this.request<BlogQueryGetSentPostResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/sent_post/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/timedout_post
   */
  queryTimedoutPostAll = (
    ...
    this.request<BlogQueryAllTimedoutPostResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/timedout_post`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/mitchellnel/ibc-planet-nel/blog/timedout_post/{id}
   */
  queryTimedoutPost = (id: string, params: RequestParams = {}) =>
    this.request<BlogQueryGetTimedoutPostResponse, RpcStatus>({
      path: `/mitchellnel/ibc-planet-nel/blog/timedout_post/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
